...
function getBathValue() {
  ...
  function onClickedEstimatePrice() {
    ...
    var url = "http://0.0.0.0:5000/predict_home_price"; //Use this if you are NOT using nginx which is first 7 tutorials
    ...
    $.post(url, {
        ...
        estPrice.innerHTML = "<h2>" + (data.estimated_price/10).toString() + " Million</h2>";
        console.log(status);
    });
  }
